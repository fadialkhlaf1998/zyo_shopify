...
class Order {
  ...
  factory Order.fromMap(Map<String, dynamic> json) => Order(
    ...
    clientDetails: ClientDetails.fromMap(json["client_details"]),
    ...
    currentSubtotalPriceSet: Set.fromMap(json["current_subtotal_price_set"]),
    currentTotalDiscounts: json["current_total_discounts"],
    currentTotalDiscountsSet: Set.fromMap(json["current_total_discounts_set"]),
    currentTotalDutiesSet: json["current_total_duties_set"],
    currentTotalPrice: json["current_total_price"],
    currentTotalPriceSet: Set.fromMap(json["current_total_price_set"]),
    currentTotalTax: json["current_total_tax"],
    currentTotalTaxSet: Set.fromMap(json["current_total_tax_set"]),
    customerLocale: json["customer_locale"],
    deviceId: json["device_id"],
    discountCodes: List<DiscountCode>.from(json["discount_codes"].map((x) => DiscountCode.fromMap(x))),
    email: json["email"],
    ...
    subtotalPriceSet: Set.fromMap(json["subtotal_price_set"]),
    tags: json["tags"],
    ...
    totalDiscountsSet: Set.fromMap(json["total_discounts_set"]),
    totalLineItemsPrice: json["total_line_items_price"],
    totalLineItemsPriceSet: Set.fromMap(json["total_line_items_price_set"]),
    totalOutstanding: json["total_outstanding"],
    totalPrice: json["total_price"],
    totalPriceSet: Set.fromMap(json["total_price_set"]),
    totalPriceUsd: json["total_price_usd"],
    totalShippingPriceSet: Set.fromMap(json["total_shipping_price_set"]),
    ...
    discountApplications: List<DiscountApplication>.from(json["discount_applications"].map((x) => DiscountApplication.fromMap(x))),
    fulfillments: List<Fulfillment>.from(json["fulfillments"].map((x) => Fulfillment.fromMap(x))),
    lineItems: List<OrderLineItem>.from(json["line_items"].map((x) => OrderLineItem.fromMap(x))),
    refunds: List<Refund>.from(json["refunds"].map((x) => Refund.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
    ...
    "client_details": clientDetails!.toMap(),
    ...
    "current_subtotal_price_set": currentSubtotalPriceSet!.toMap(),
    "current_total_discounts": currentTotalDiscounts,
    "current_total_discounts_set": currentTotalDiscountsSet!.toMap(),
    "current_total_duties_set": currentTotalDutiesSet,
    "current_total_price": currentTotalPrice,
    "current_total_price_set": currentTotalPriceSet!.toMap(),
    "current_total_tax": currentTotalTax,
    "current_total_tax_set": currentTotalTaxSet!.toMap(),
    "customer_locale": customerLocale,
    "device_id": deviceId,
    "discount_codes": List<dynamic>.from(discountCodes!.map((x) => x.toMap())),
    "email": email,
    ...
    "subtotal_price_set": subtotalPriceSet!.toMap(),
    "tags": tags,
    ...
    "total_discounts_set": totalDiscountsSet!.toMap(),
    "total_line_items_price": totalLineItemsPrice,
    "total_line_items_price_set": totalLineItemsPriceSet!.toMap(),
    "total_outstanding": totalOutstanding,
    "total_price": totalPrice,
    "total_price_set": totalPriceSet!.toMap(),
    "total_price_usd": totalPriceUsd,
    "total_shipping_price_set": totalShippingPriceSet!.toMap(),
    "total_tax": totalTax,
    ...
    "discount_applications": List<dynamic>.from(discountApplications!.map((x) => x.toMap())),
    "fulfillments": List<dynamic>.from(fulfillments!.map((x) => x.toMap())),
    "line_items": List<dynamic>.from(lineItems!.map((x) => x.toMap())),
    "refunds": List<dynamic>.from(refunds!.map((x) => x.toMap())),
